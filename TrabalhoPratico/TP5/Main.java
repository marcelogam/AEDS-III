...
public class Main {
    public static void main(String[] args) throws Exception {
        // Criacao da arvore
        ArvoreB arvore = new ArvoreB(8, "BancoDeDados/indexArvore");

        // Criacao da Tabelahash
        HashExtensivel indexHash = new HashExtensivel(2000, "BancoDeDados/diretorio.db",
                "BancoDeDados/indexTabelaHash.db");
